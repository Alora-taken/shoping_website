"""
Django settings for shoping_site project.
...
SECRET_KEY = 'django-insecure-g5^9n^%1(xjpkouhkis6uat3!m#c6@luld7z-+7o*_7g(k0r_c'
...
ROOT_URLCONF = 'shoping_site.urls'
...
WSGI_APPLICATION = 'shoping_site.wsgi.application'
